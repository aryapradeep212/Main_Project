...
const AluminiList = () => {
  ...
  return (
    <>
      <NavBar />
      <Typography variant='h3' style={{ marginTop: "100px" }}>Alumini</Typography>
      <div className={styles.container}style={{ display: 'flex', flexWrap: 'wrap', gap: '150px', justifyContent: 'center', padding: '60px', marginTop: '10px' }}>
