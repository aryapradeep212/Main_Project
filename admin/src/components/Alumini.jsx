  ...
  const handleDelete = async (userId) => {
    ...
    try {
      const response = await axios.delete(
        "http://localhost:9453/deletealumini/" + userId,
      );
        ...
        >
          {aluminiData.map((alumini) => (
            ...
            >
              <h2>{alumini.name}</h2>
              <p>
                <strong>Company:</strong> {alumini.company}
              </p>
              <p>
                <strong>Department:</strong> {alumini.department}
              </p>
              <p>
                <strong>Batch:</strong> {alumini.batch}
              </p>
              <div
                style={{
                  display: "flex",
              ...
              >
                <button
                  ...
                  onClick={() => handleDelete(alumini._id)}
                >
                  Delete
                </button>
